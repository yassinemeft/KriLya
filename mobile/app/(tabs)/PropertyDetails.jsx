...
export default function PropertyDetails() {
  ...
  return (
    <View>
      <HStack
        space="4xl"
        className="flex-1 hidden sm:flex  justify-center mt-8 bg-white dark:bg-gray-900 px-4 pt-4 pb-20"
      >
        ...
        <View style={{ width: width * 0.4 }}>
          ...
          <View className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
            <Text className="text-xl font-bold mb-4 text-gray-900 dark:text-white">
              {t("listed_by")}
            </Text>
            ...
            <DetailRow
              label={t("email")}
              value={house.owner?.email || "Unknown"}
            />
            <DetailRow
              label={t("phone")}
              value={house.owner?.phone || "Unknown"}
            />
            <DetailRow
              label={t("company_name")}
              value={house.owner?.company || "Unknown"}
            />

            <View className="mt-2">
              <Text className="text-gray-700 dark:text-gray-300">
                {house.owner?.description || "Unknown"}
              </Text>
            </View>
            <Button
              variant="solid"
