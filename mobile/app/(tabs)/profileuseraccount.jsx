      ...
      <Box className="p-4 items-center">
        <Card className="bg-white dark:bg-black w-full max-w-md rounded-2xl p-4 shadow-md">
          <VStack className="items-center space-y-4">
            ...
            <Text className="text-blue-600 dark:text-blue-200">
              {user.email}
            </Text>
          </VStack>
        ...
        {/* Styled Modify Button */}
        <Button className="mt-6 w-44 bg-brandRed-500 data-[hover=true]:bg-brandRed-300 dark:bg-brandBlue-500 dark:data-[hover=true]:bg-brandBlue-300 rounded items-center justify-center self-center">
